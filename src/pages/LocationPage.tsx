                ...
                <div className="location_header_top">
                    ...
                    <div className="last_updated">
                        ...
                        {convertDateToReadable(
                            weatherQuery.data.properties.meta.updated_at,
                        )}
                    </div>
                </div>
                <div className="location_header">
                    <div className="location_header_name">
                        ...
                        <div>
                            ...
                            <h2>
                                {locationData.navn[0].kommuner?.[0].kommunenavn}
                            </h2>
                        </div>
                    </div>
                    <div className="location_header_info">
                        <h1
                            className={
                                weatherQuery.data.properties.timeseries[2].data
                        ...
                        {weatherQuery.data.properties.timeseries[1].data
                            .next_1_hours.summary.symbol_code && (
                            <WeatherIcon
                                symbol_code={
                                    weatherQuery.data.properties.timeseries[1]
                        ...
                        <tbody>
                            {next24HoursWeather.map((weather, index) => {
                                ...
                                const adjustedWeather =
                                    weatherQuery.data.properties.timeseries[
                                        index + 2
                                    ];
                                return (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            {weather.data.next_1_hours.summary
                                                .symbol_code ? (
                                                <WeatherIcon
                                                    symbol_code={
                                                        weather.data
                                        ...
                                        <td className="negative-temperature">
                                            {
                                                adjustedWeather.data
                                        ...
                                        <td className="hidden_column">
                                            ...
                                            <img
                                                ...
                                                className="wind_icon"
                                                style={{
                                                    transform: `rotate(${adjustedWeather.data.instant.details.wind_from_direction}deg)`,
                                                }}
                                            />
                                        </td>
                                        <td className="hidden_column">
